 ...
 */
export function BrandLockup({ priority = false }: BrandLockupProps): ReactElement {
  return (
    <span className="flex items-center gap-3">
      <Image src={brandAssets.faviconGoldNoBackground.image} alt="" className="size-8" priority={priority} />
